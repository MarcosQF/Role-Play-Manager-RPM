...
from rpm.games.schemas import GameCreate, GameResponse, GameResponseList, GameUpdate
...
@router.get("/{game_id}", response_model=GameResponse, status_code=HTTPStatus.OK)
...
@router.patch("/{game_id}", response_model=GameResponse, status_code=HTTPStatus.OK)
